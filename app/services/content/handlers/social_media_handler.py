...
from app.services.content.contexts.base_context import SocialMediaWorkflowContext
from app.services.content.handlers.base_handler import BaseHandler


class SocialMediaHandler(BaseHandler):
    """Handler for the social media posting workflow."""
    
    def __init__(self, whatsapp: WhatsApp, state_manager: StateManager):
        super().__init__(whatsapp, state_manager, SocialMediaWorkflowContext)
    
    async def start_workflow(self, client_id: str) -> None:
    ...
    async def _handle_platform_selection(self, client_id: str) -> None:
        ...
        context = SocialMediaWorkflowContext()
        ...
        self.set_state(client_id, WorkflowState.PLATFORM_SELECTION)
    ...
    async def _handle_content_type_common(self, client_id: str) -> None:
        ...
        if common_content_types and len(context.selected_platforms) > 1:
            ...
            self.set_state(client_id, WorkflowState.SAME_CONTENT_CONFIRMATION)
        else:
    ...
    async def handle_same_content_confirmation(self, client_id: str, message: str) -> None:
        ...
        if message.lower() == "yes":
            ...
            common_types = context.common_content_types or []
            buttons = [
            ...
            self.set_state(client_id, WorkflowState.CONTENT_TYPE_SELECTION)
    ...
    async def _handle_platform_specific_content(self, client_id: str) -> None:
        ...
        self.set_state(client_id, WorkflowState.PLATFORM_SPECIFIC_CONTENT)
    ...
    async def _handle_caption_input(self, client_id: str) -> None:
        ...
        self.set_state(client_id, WorkflowState.CAPTION_INPUT)
    ...
    async def _handle_schedule_selection(self, client_id: str) -> None:
        ...
        self.set_state(client_id, WorkflowState.SCHEDULE_SELECTION)
    ...
    async def _handle_confirmation(self, client_id: str) -> None:
        ...
        self.set_state(client_id, WorkflowState.CONFIRMATION)
